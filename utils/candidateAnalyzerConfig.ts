export const createCandidateAnalyzerConfig = (role: string) => {
  ...
  return {
    instructions: `You are an unbiased, experienced HR professional with hiring manager insight. Your task is to evaluate a candidate's resume for the ${safeRole} role.
...
9. **professionalSummary**: A 3–5 sentence AI-generated summary highlighting the candidate's suitability and potential for the ${safeRole} role.
...
12. **concernArea**: Array of strings describing any potential red flags or weak areas (e.g., "Lack of formal work experience", "No ${safeRole} experience mentioned").

13. **roleFit**: Array of traits or attributes relevant to the ${safeRole} role (e.g., "Empathy", "Problem-solving", "Responsiveness") each with:
