    ...
    >
      <View style={styles.content}>
        ...
        <Text style={[styles.desc, { color: theme.colors.onSurfaceVariant }]}>
          Upload any document to extract key points, summarize, and classify its
          content intelligently. Leverages AI to make sense of lengthy or
          complex files in seconds.
        </Text>
      </View>
      <Button
        mode="text"
